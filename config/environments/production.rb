Rails.application.configure do
  ...
  config.assets.precompile += %w( #{Rails.root}/vendor/assets/stylesheets/active_admin.scss)
  ...
  :s3_domain_url => ':asset_host', #CORRECT THIS TO :asset_host AND GET THIS SHIT WORKING!!!
  :s3_credentials => {
